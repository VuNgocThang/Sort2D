...
public class AirbridgeSettingsWindow : EditorWindow
{
    ...
    internal static void UpdateAndroidManifest()
    {
        try
        {
            ...
            string defaultManifestPath =
                Path.Combine(Application.dataPath, "Plugins/Airbridge/Android/AndroidManifest.xml");
        ...
        {
            Debug.LogError("Something broken while updating Android App Manifest file.");
        }
    }
    ...
    internal static void UpdateAndroidAirbridgeSettings()
    {
        ...
        {
            Debug.LogError("Something broken while updating Android Airbridge settings file.");
        }
    }
    ...
    internal static void UpdateiOSAppSetting()
    {
        ...
        {
            Debug.LogError("Something broken while updating iOS Airbridge settings file.");
        }
    }
}
#endif